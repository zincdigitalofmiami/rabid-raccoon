...
import IntelligenceConsole from "./MesIntraday/IntelligenceConsole";
  ...
  return (
    <div className="rounded-xl border border-[var(--zf-border-soft)] bg-[var(--zf-surface-elev)] p-6 hover:border-[var(--zf-border)] transition-colors">
      ...
      <div className="flex items-start justify-between mb-5">
        <div>
          <span
            className={`inline-flex items-center gap-2 px-3 py-1 rounded-lg border text-sm font-bold ${dirBg} ${dirColor}`}
          >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-10">
        ...
        <div className="mb-10">
          <SectionHeader
            ...
            badge={
              tradeCount > 0
                ? `${tradeCount} SETUP${tradeCount !== 1 ? "S" : ""}`
                : undefined
            }
          />
