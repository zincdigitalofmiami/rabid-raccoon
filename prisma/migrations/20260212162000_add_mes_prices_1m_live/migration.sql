CREATE TABLE "mes_prices_1m" (
    ...
    CONSTRAINT "mes_prices_1m_pkey" PRIMARY KEY ("id")
);

CREATE UNIQUE INDEX "mes_prices_1m_event_time_key" ON "mes_prices_1m"("eventTime");
CREATE INDEX "mes_prices_1m_event_time_idx" ON "mes_prices_1m"("eventTime");
